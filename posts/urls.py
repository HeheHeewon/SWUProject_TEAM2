...
from .views import (
  ...
  DemandDeleteView, SupplyDeleteView,
  SupplyOnlyListView, DemandOnlyListView, DualListView,  # ← 추가
)
...
urlpatterns = [
  ...
  path("browse/", SupplyOnlyListView.as_view(), name="browse"),
  path("demand/browse/", DemandOnlyListView.as_view(), name="browse_demand"),  # 이런 커피를 찾아요
  path("browse/all/", DualListView.as_view(), name="browse_all"),
